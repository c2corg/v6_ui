...
export default class SimplifyService {
   ...
   * @private
   */
  simplifyRadialDist_(points, sqTolerance) {
   ...
   * @private
   */
  simplifyDPStep_(points, first, last, sqTolerance, simplified) {
   ...
   * @private
   */
  simplifyDouglasPeucker_(points, sqTolerance) {
   ...
   * @private
   */
  simplify_(points, tolerance, highestQuality) {
    if (points.length <= 2) {
      return points;
    }
